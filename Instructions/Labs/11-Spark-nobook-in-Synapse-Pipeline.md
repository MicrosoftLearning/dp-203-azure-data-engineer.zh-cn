...
10 然后在“开发”页面上展开“笔记本”，单击“+导入”选项 ![Spark 笔记本导入](./images/spark-notebook-import.png)********
    
        
1. 选择刚下载并保存为 **Spark Transfrom.ipynb** 的文件。
2. 将笔记本附加到 sparkxxxxxxx Spark 池**。
3. 查看笔记本中的笔记并运行代码单元格。
...
5. 在笔记本工具栏中，将笔记本附加到 spark*xxxxxxx* Spark 池，然后使用“&#9655; 全部运行”按钮运行笔记本中的所有代码单元格********。
  
    Spark 会话可能需要几分钟才能启动，随后代码单元格才能运行。

6. 运行所有笔记本单元格后，请记下保存转换后的数据的文件夹的名称。
7. 请切换到仍应打开的“files”选项卡并查看根“files”文件夹********。 如有必要，请在“更多”菜单中选择“刷新”以查看新文件夹********。 然后打开该文件夹，验证它是否包含 Parquet 文件。
8. 返回到根“files”文件夹，选择笔记本生成的唯一名称文件夹，然后在“新建 SQL 脚本”菜单中选择“选择前 100 行”************。
9. 在“选择前 100 行”窗格中，将文件类型设置为“Parquet 格式”并应用更改********。
10. 在打开的新 SQL 脚本窗格中，使用“&#9655; 运行”按钮运行 SQL 代码并验证它是否返回转换后的销售订单数据****。
