...
9. 在包含数据湖文件系统的“file”选项卡上，查看 sales 文件夹的内容（必要时刷新视图）并验证是否已创建新的 productsales 文件夹  。
...
6. 在包含数据湖文件系统的“file”选项卡上，查看 sales 文件夹的内容（必要时刷新视图）并验证是否已创建新的 yearlysales 文件夹  。
...
9. 切换回“file”选项卡，并查看 sales 文件夹 。 然后选择“yearlysales”文件夹并将其删除。
